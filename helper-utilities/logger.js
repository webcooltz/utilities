...
// Main function
const writeToLogfile = (typeOfMessage, dataToBeLogged) => {
  const dataToLog = typeOfMessage + " - " + dataToBeLogged;
  ...
  fs.readFile(logfilePath, 'utf8', (err, data) => {
    if (err) {
      ...
      if (lastLine && lastLine.includes(dataToLog)) {
